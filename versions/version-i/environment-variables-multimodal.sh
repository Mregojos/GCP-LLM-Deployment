...
export VERSION="i"
export APP_NAME="multimodal-$VERSION" # Multi-Modal Large Language Model (MM-LLM) or Multi-Modal Model (MMM)
...
export STARTUP_SCRIPT_BUCKET_CUSTOM_ROLE="mmBucketCustomRole.$VERSION"
...
export APP_CUSTOM_ROLE="mmCustomRole.$VERSION"
export APP_PORT=9000
